package com.sankuai.waimai.router.javatest;
...
/**
 * 描述: 测试ParameterizedType
 *
 * 责任人:cl
 */
public class TestParameterTypes {
    public static void main(String[] args) throws NoSuchMethodException, SecurityException {
        Method method = TestParameterTypes.class.getMethod("testType", List.class, List.class, List.class, List.class, List.class, Map.class);
